...
defined('MAP_SHORT_NAME') || define('MAP_SHORT_NAME', 'LN_Floor00');
defined('REQ_CODE_POD_BERTH') || define('REQ_CODE_POD_BERTH', 'QPBM');
defined('REQ_CODE_AGV_STATUS') || define('REQ_CODE_AGV_STATUS', 'QAS');
defined('MAP_CODE_AGV_STATUS') || define('MAP_CODE_AGV_STATUS', 'LA');
